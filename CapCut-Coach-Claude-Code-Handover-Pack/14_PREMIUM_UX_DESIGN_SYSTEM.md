...
- **Add a finished example** — optional for a new edit, required for learning.

After selection, Coach shows: `11 reels found · 43 raw clips · 2 finished references`. It proposes pairings visually. The owner confirms the overall grouping instead of renaming files manually.
...
2. add a script ZIP, raw footage and finished video;
3. confirm automatic grouping;
4. review Faithful/Enhanced edits;
5. continue in CapCut;
