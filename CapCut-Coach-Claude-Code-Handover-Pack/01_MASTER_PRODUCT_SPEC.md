...
CapCut Coach is a private local editing assistant for one beginner using CapCut Premium on an M2 Mac. It automates the measurable and repetitive parts of short-form editing, learns a universal editing fingerprint from paired examples, transfers a strong draft into CapCut through the safest available method, gives contextual beginner guidance for the remaining Premium work, and reviews each export.

It is not a replacement for CapCut, a cloud video editor, a CapCut license bypass, a public product, or a promise of viral performance.

## 2. Supported scope

### Version 1 primary format
...
- Talking-head, educational, testimonial and simple offer videos.

### Deferred formats

- True multi-camera podcast switching.
- Music videos and beat-heavy montage edits.
...
- Detect new media and CapCut projects.
...
- When compatibility is proven, create a duplicated CapCut draft from a tested Premium master template.
- Otherwise prepare a one-click handoff package and open it beside Guided Mode.
...
Screen 1: **Welcome**  
“CapCut Coach prepares your edits, opens them in CapCut and teaches you the remaining steps.”

Screen 2: **Computer check**

- Detect Apple chip, RAM, macOS version and free storage.
- Detect CapCut bundle, version and project directory.
...
- CapCut project folder access.
- Export folder access.
- Notifications.
- Optional Accessibility access.
- Optional Screen Recording access used only for **I'm stuck**.

Screen 4: **Teach Coach your style**

- Import paired examples now or skip.
- Explain that 10 examples begin the profile and 15–20 are recommended.
- Let the user rate each final as Excellent, Good, Average or Do Not Copy.

Screen 5: **Test connection**

- Create/read a disposable canary project.
- Report one of: Direct CapCut connection supported; Safe handoff supported; Read-only connection only.
...
- Confidence flags.
- Buttons: **Approve**, **Change Hook**, **Make Faster**, **Make Calmer**, **Open in CapCut**, **Learn This Edit**.
...
| CapCut adapter | capcut-cli wrapper plus custom version gate | Safer draft inspection/writes |
...
## 10. Style learning from paired raw and final videos
...
- **Faithful** — reproduce learned preferences with minimal experimentation.
...
### Lane B — safe handoff, required fallback
...
- This lane must remain functional even if all direct adapters are disabled.

### Lane C — template-cloned direct draft, preferred automation

- User creates one known-good Premium master project in CapCut.
...
- Preserve Premium resource ids inside CapCut rather than exporting them externally.
