...
```json
{
  ...
  "automation_level": "review_first_cut",
  "cold_start_enabled": true,
  "candidate_strengths": ["clean", "enhanced", "bold"],
  "primary_renderer": "ffmpeg_local",
  "capcut_optional": true,
...
- `GET /projects/{id}/render-graph`
- `POST /projects/{id}/render-candidates`
- `POST /projects/{id}/revise-candidate`
- `POST /projects/{id}/select-candidate`
- `POST /projects/{id}/render-final`
- `POST /projects/{id}/autopilot`
...
All endpoints in this group are optional adapters. No normal project may depend on them.
