...
Start with `00_READ_ME_FIRST.md`, then read every numbered file through `17_AUTONOMY_POLICY_AND_HUMAN_GATES.md`. Paste `07_START_PROMPT_FOR_CLAUDE_CODE.md` into Claude Code to begin.
