# Optional Dataset and Universal Style-Learning Guide

The application must be useful before this guide is used. Zero-example cold start is specified in `16_ZERO_EXAMPLE_COLD_START.md`; historical raw/final pairs are an optional accelerator after the local renderer works.
